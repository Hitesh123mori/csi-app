...
class ReactionBox extends StatefulWidget {
  @override
  createState() => ReactionBoxState();
}

class ReactionBoxState extends State<ReactionBox> with TickerProviderStateMixin {
  ...
  late Animation pushIconLikeUp, pushIconLoveUp, pushIconHahaUp, pushIconWowUp;
  late Animation zoomIconLike, zoomIconLove, zoomIconHaha, zoomIconWow;
  ...
  // 0 = nothing, 1 = like, 2 = love, 3 = haha, 4 = wow
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/reactions/ic_like_fill.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/reactions/ic_like_fill.png';
        case 2:
          return 'assets/reactions/love2.png';
        case 3:
          return 'assets/reactions/haha2.png';
        case 4:
          return 'assets/reactions/wow2.png';
        default:
          return 'assets/reactions/ic_like.png';
      }
    } else {
      return 'assets/reactions/ic_like.png';
    }
  ...
  void onHorizontalDragUpdateBoxIcon(DragUpdateDetails dragUpdateDetail) {
    ...
    if (dragUpdateDetail.globalPosition.dy >= 200 && dragUpdateDetail.globalPosition.dy <= 500) {
      ...
      if (dragUpdateDetail.globalPosition.dx >= 20 && dragUpdateDetail.globalPosition.dx < 120) {
        if (currentIconFocus != 1) {
          handleWhenDragBetweenIcon(1);
        }
      } else if (dragUpdateDetail.globalPosition.dx >= 120 && dragUpdateDetail.globalPosition.dx < 190) {
        if (currentIconFocus != 2) {
          handleWhenDragBetweenIcon(2);
        }
      } else if (dragUpdateDetail.globalPosition.dx >= 190 && dragUpdateDetail.globalPosition.dx < 240) {
        if (currentIconFocus != 3) {
          handleWhenDragBetweenIcon(3);
        }
      } else if (dragUpdateDetail.globalPosition.dx >= 260 && dragUpdateDetail.globalPosition.dx < 300) {
  ...
  void showBox() {
    playSound('assets/sounds/box_up.mp3');
    isLongPress = true;
